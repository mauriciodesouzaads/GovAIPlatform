...
# Suíte completa com banco (554 padrão + 39 garantias DB real)
...
Todas as migrations são numeradas (`011_*.sql` … `049_*.sql`) e aplicadas em ordem pelo `scripts/migrate.sh`. Total: **39 migrations**.
