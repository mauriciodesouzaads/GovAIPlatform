...
export default function ChatLayout({ children }: { children: React.ReactNode }) {
    return (
        <div className="fixed inset-0 bg-[#0C0F14] text-zinc-100 flex font-sans antialiased">
            <aside className="hidden md:flex w-72 flex-shrink-0 border-r border-white/5 bg-[#0a0d12] flex-col">
                <ChatSidebar />
            </aside>
            ...
            <Toaster
                ...
                toastOptions={{
                    classNames: {
                        toast: 'bg-[#141820] border border-white/10 text-zinc-100',
                    },
                }}
            />
        </div>
